...
(function() {
  ...
  var _Map, _Set, error, etc, isType, maybe, promised, sig, typeName, typeOf;
  ...
  isType = function(val, type) {
    ...
    switch (typeOf(type)) {
      ...
      case 'Function':
        switch (type) {
          case maybe:
            return true; // `maybe` function used directly
          case promised:
          ...
          default:
            return (val != null ? val.constructor : void 0) === type; // native (Number, String, Object, Array (untyped), Promise…) and class types
        }
        break;
      case 'Array':
        switch (type.length) {
