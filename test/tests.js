...
(function() {
  var NATIVE_TYPES, VALUES, chai, chaiAsPromised, expect, isType, promised, sig, testTypes, typeOf;
  ...
  */
  describe("isType", function() {
    context("Special Types", function() {
      context("Optional parameter type (undefined)", function() {
        return it("should return true only when value is undefined", function() {
          var i, len, results, val;
          expect(isType(void 0, void 0)).to.be.true;
          results = [];
          for (i = 0, len = VALUES.length; i < len; i++) {
            val = VALUES[i];
            if (val !== void 0) {
              results.push(expect(isType(val, void 0)).to.be.false);
            }
          }
          return results;
        });
